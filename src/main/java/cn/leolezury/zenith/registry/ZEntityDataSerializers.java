...
public class ZEntityDataSerializers {
	...
	public static final DeferredHolder<EntityDataSerializer<?>, EntityDataSerializer<ZenithPart>> ZENITH_PART = ENTITY_DATA_SERIALIZERS.register("zenith_prt", () -> EntityDataSerializer.forValueType(ZenithPart.STREAM_CODEC));
}
